...
const envSchema = z.object({
	...
	LOGIN_OTP_RESEND_COOLDOWN_SECONDS: z.coerce.number().int().positive().default(60),
	LOGIN_OTP_RATE_WINDOW_SECONDS: z.coerce.number().int().positive().default(900),
	LOGIN_OTP_MAX_PER_WINDOW: z.coerce.number().int().positive().default(5),
	...
	PASSWORD_RESET_OTP_RESEND_COOLDOWN_SECONDS: z.coerce.number().int().positive().default(60),
	PASSWORD_RESET_OTP_RATE_WINDOW_SECONDS: z.coerce.number().int().positive().default(900),
	PASSWORD_RESET_OTP_MAX_PER_WINDOW: z.coerce.number().int().positive().default(5),
